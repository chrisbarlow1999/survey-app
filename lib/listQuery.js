...
export const PROJECT_SORT_OPTIONS = [
  ...
  { value: 'install_asc', label: 'Install date (soonest)', column: 'install_date', ascending: true },
  { value: 'install_desc', label: 'Install date (latest)', column: 'install_date', ascending: false },
  { value: 'screens_desc', label: 'Screens (most)', column: 'screen_count', ascending: false },
  { value: 'screens_asc', label: 'Screens (fewest)', column: 'screen_count', ascending: true },
  { value: 'value_desc', label: 'Value (highest)', column: 'value_gbp', ascending: false },
  { value: 'value_asc', label: 'Value (lowest)', column: 'value_gbp', ascending: true },
